        ...
        <div class="main-panel">
            ...
            <div class="content" style="margin-top: -15px;">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header" data-background-color="green">
                                    <h1 class="title"><b>Production</b><small style="color:white;font-family:Maiandra GD"> (Male Category)</small></h1>
                                ...
                                <div class="card-content table-responsive">
                                    ...
                                    <table class="table" id="dataTable2">
                                        <thead style="font-weight: bold;color: black;font-size: 100%">
                                            ...
                                            <th>Poise and Bearing(30pts)<br><small style="font-family:arial;font-size:11px">3 judges average</small></th>
                                            <th>Mastery(30pts)<br><small style="font-family:arial;font-size:11px">3 judges average</small></th>
                                            <th>Self Introduction(30pts)<br><small style="font-family:arial;font-size:11px">3 judges average</small></th>
                ...
                <?php
                        ...
                        $sql = mysqli_query($link,"SELECT p.name, p.name_judge, p.candidate_no, p.team,
                       SUM(p.poiseandbearing)/7 AS 'poiseandbearing', 
                       SUM(p.mastery)/7 AS 'mastery', 
                       SUM(p.self_introduction)/7 AS 'self_introduction', 
                       SUM(p.audience_impact)/7 AS 'audience_impact', 
                       r.no AS 'no', 
                       DENSE_RANK() OVER (ORDER BY SUM(p.poiseandbearing + p.mastery + p.self_introduction + p.audience_impact) DESC) AS 'total_rank'
                        FROM production p 
                        JOIN (SELECT no FROM rank GROUP BY no ORDER BY no ASC) g ON p.candidate_no = g.no 
                        JOIN rank r ON p.candidate_no = r.no 
                        WHERE p.gender = 'Male' 
                        GROUP BY p.name, r.no 
                        ORDER BY p.candidate_no ASC, r.no ASC
                            ");
                        for($a = 0 ; $a < $num_rows = mysqli_fetch_array($sql) ; $a++ )
                        {
                            ...
                            $poiseandbearing_average = ROUND($poiseandbearing,2);
                            $mastery_average = ROUND($mastery,2);
                            $self_introduction_average = ROUND($self_introduction,2);
                            $audience_impact_average = ROUND($audience_impact,2);
                            $production_total = ROUND($poiseandbearing_average + $mastery_average + $self_introduction_average + $audience_impact_average,2);
                            ...
                            echo ">";
                               echo" <td>$candidate_no</td>
                                <td>$team</td>
                                <td>$name</td>
                                <td>$poiseandbearing_average</td>
                                <td>$mastery_average</td>
                                <td>$self_introduction_average</td>
                ...
                ?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header" data-background-color="green">
                                    <h1 class="title"><b>Production</b><small style="color:white;font-family:Maiandra GD"> (Female Category)</small></h1>
