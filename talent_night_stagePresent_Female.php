...
<html lang="en">
  <head>
    ...
    <title>Talent Portion - Female</title>
        ...
        <div class="container">
								<?php
										...
										$link = mysqli_connect("localhost","root","","tabulation");
											...
											$judge = $_SESSION['login_judge'];
											$sql5 = mysqli_query($link,"SELECT  * from score_card where name_judge = '$judge' and gender = 'Female' GROUP BY talent_portion_stagePresent_vote ORDER BY talent_portion_stagePresent_vote ASC LIMIT 1");
        ...
        <div class="container">
		      <h3 class="jumbotron-heading" style="font-family: 'Livvic', sans-serif;">Talent Portion (100pts)</h3>
		        <p style="font-family: OCR A">CRITERIA:
							<ul>
								<li class="active">
										<a href="talent_night_stagePresent_Female.php" style="font-family: 'Livvic', sans-serif"><i class="fa fa-arrow-right" style="margin-left: -18px"></i> Stage Present (20pts) | Female</a><br>
								<li><a href="talent_night_mastery_Female.php" style="color: black;font-family: 'Livvic', sans-serif;" onMouseOver="this.style.color='red'" onMouseOut="this.style.color='black'">Mastery (40pts) | Female</a></li>
								<li><a href="talent_night_uniqueness_Female.php" style="color: black;font-family: 'Livvic', sans-serif;" onMouseOver="this.style.color='red'" onMouseOut="this.style.color='black'">Uniqueness (30pts) | Female</a></li>
								<li><a href="talent_night_audience_impact_Female.php" style="color: black;font-family: 'Livvic', sans-serif;" onMouseOver="this.style.color='red'" onMouseOut="this.style.color='black'">Audience Impact (10pts) | Female</a></li>
							</ul>
						</p>
        </div>
      </section>
									...
									<div class='modal-body'>
										...
										<p style="font-family: 'Livvic', sans-serif;color:red">Note: You can only update once.</p>
										  ...
										  <text style="font-family: 'Livvic', sans-serif;">Contestant Team:</text> <input type="text" id = "team" class="re"readonly disabled/><br>
											...
											<text style="font-family: 'Livvic', sans-serif;">New Score:</text> <input type="number" min="1" max="20" name="edit_scoreInput" class="red" required aria-describedby='button-addon3' autofocus />
									</div>
									<div class='modal-footer'>
