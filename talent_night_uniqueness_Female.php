...
<html lang="en">
  <head>
    ...
    <title>Talent Portion | Female (Uniqueness 30pts)</title>
        ...
        <div class="container">
								<?php
										...
										$link = mysqli_connect("localhost","root","","tabulation");
											...
											$judge = $_SESSION['login_judge'];
											$sql5 = mysqli_query($link,"SELECT  * from score_card where name_judge = '$judge' and gender = 'Female' GROUP BY talent_portion_uniqueness_vote ORDER BY talent_portion_uniqueness_vote ASC LIMIT 1");
		      ...
		      <h3 class="jumbotron-heading" style="font-family: 'Livvic', sans-serif;">Talent Portion (100pts)</h3>
		        <p style="font-family: OCR A">CRITERIA:
							<ul>
								...
								<li class="active">
									<a href="talent_night_uniqueness_Female.php" style="color: red;font-family: 'Livvic', sans-serif;" ><i class="fa fa-arrow-right" style="margin-left: -18px"></i> Uniqueness (30pts) | Female</a>
								</li>
								<li>
													...
													<div class = 'col-md-6 col-lg-4 my-7'>
														<form method = 'post'>
															<div class='input-group mb-3'>
															  <input type='number' min='1' max = '30' class='form-control' placeholder='Score for Uniqueness' aria-label='Recipient's username' aria-describedby='button-addon2' name = 'score' required maxlength='2' pattern='[0-9]{1,}'>
						...
						<div class='modal fade' id='editScoreModal' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel'           aria-hidden='true'>
							<div class='modal-dialog' role='document'>
								<div class='modal-content'>
									...
									<div class='modal-body'>
										<h6 style="font-family: 'Livvic', sans-serif;font-weight: bold;">Uniqueness | Female (30pts)</h6><p></p>
