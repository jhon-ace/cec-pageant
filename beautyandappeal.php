      ...
      echo "<script type='text/javascript'>alert('$message'); window.location.assign('sports_wear.php')</script>";
			...
			if(isset($_POST['submit_edit_score']))
			{
				...
				$edit_name_contestant = $_POST['edit_name_contestant'];
						...
						$updateScoreCard = "UPDATE score_card SET sports_wear = '$edit_scoreInput',sports_wear_vote = '1' WHERE name_contestant = '$edit_name_contestant' AND name_judge = '$edit_judge'";
														...
														if($name_judge == $judge)
														{
															$sports_wear_vote = $num_rowst['sports_wear_vote'];
																...
																if($sports_wear_vote == 0)
																	{
																		echo "<a href='#'><span class='navbar-brand' href='#''><button class = 'btn btn-outline-info' type='button' data-toggle='modal' data-target='#exampleace'>Back to Categories</button></span></a>";
																	}
																	else
																	{
      ...
      <section class="jumbotron jumbotron-fluid text-left py-4">
        <div class="container">
		      <h3 class="jumbotron-heading">Sports Wear (100%)</h3>
		        <p>CRITERIA:
							<ul>
								<li><a href="sports_wear_relevance.php">Relevance to Sports (30)</a></li>
								<li  class="active"><a href="">Beauty and Appeal (25)</a></li>
							...
							for($a = 0 ; $a < $num_rows = mysqli_fetch_array($sql) ; $a++ )
									{
										...
										<div class='media-body'>
										  <img class='align-self-start mr-3' src='img/candidates/$picture' height='200px' alt='Generic placeholder image'>
										</div>
											<div class='media col-md-12 my-4'>
												<div class='media-body'>
													<h5 class='mt-0'>Candidate #$candidate_no - $team</h5>
										...
										else
										{
											...
											echo "
											<div class='col-md-6 col-lg-7 my-4'>
												<table>
													<tr>
														...
														<td style='display:none'>$full_name</td>
														<td><center>
														  <span style = 'color:red;'>Your vote has already been recorded for this contestant!</span><br>
														  <a href='' class='editScore' data-toggle='modal' data-target='#editScoreModal' style='text-decoration:none;color: black'><span class='btn' style='border: 1px solid black'><i class='fa fa-pencil-square-o' style='color:black'> Edit Score</i></span></a>
														</center></td>
													</tr>
												</table>
											</div>
							...
							<div class='modal-dialog' role='document'>
								<div class='modal-content'>
									...
									<div class='modal-body'>
											Submitted Score: <input style="number" id = "initial_score" class="re"readonly /><br>
											<input style="text" id = "judge" name="edit_judge" class="re"readonly hidden /><br>
											<input style="text" id = "name_contestant" name="edit_name_contestant" class="re"readonly hidden /><br>
											New Score: <input style="number" min="1" max="30" name="edit_scoreInput" class="red" required aria-describedby='button-addon3'/>
									</div>
									<div class='modal-footer'>
										<button class='btn btn-secondary' type='button' data-dismiss='modal'>Cancel</button>
										<button class = 'btn btn-danger' type="submit" name ="submit_edit_score" id='button-addon3'>Submit</button>
