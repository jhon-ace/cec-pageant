...
<html lang="en">
  <head>
    ...
    <title>Production | Male No. 5</title>
...
-->
    ...
    <main role="main">
      <section class="jumbotron jumbotron-fluid text-left py-4">
        <div class="container">
		      <h3 class="jumbotron-heading">Production Number (100%) | <text style='color:red;font-family: Arial Rounded MT;'>MALE NO. 5 - ORION</text></h3>
		        <p>CRITERIA:
							<ul>
							...
							<ul style="list-style-type: none;font-size: 18px !important;">
								...
								<li class="active"   style="display: inline;padding-right: 15px;font-family: Arial"><a href="production_male_5.php" ><b># 5</b></a></li>
