        ...
        <div class="container">
								<?php
										$link = mysqli_connect("localhost","root","","tabulation");
											...
											$judge = $_SESSION['login_judge'];
											$sql5 = mysqli_query($link,"SELECT  * from score_card where name_judge = '$judge' and id_contestant = 5 GROUP BY production_audience_impact_vote ORDER BY production_audience_impact_vote DESC LIMIT 1");
		      ...
		      <h3 class="jumbotron-heading">Production Number (100%) | MALE</h3>
		        <p>CRITERIA:
							...
							<ul style="list-style-type: none;font-size: 18px !important;">
								...
								<li class="active" style="display: inline;padding-right: 15px;font-family: Arial"><a class="linkage" href="production_male_5.php" ><b># 5</b></a></li>
								<?php 
														...
														if($name_judgeD == $judge)
														{
															$production_audience_impact_vote = $num_rowst['production_audience_impact_vote'];
																...
																if($production_audience_impact_vote == 0)
																	...
																	{
																		echo '<li  style="display: inline;padding-right: 15px"><a class="linkage" href="production_male_6.php" style="color:black;font-family: Arial"># 6</a></li>';
	        ...
	        <center>
	          <div class="row">
				  		<?php
							...
							$sql = mysqli_query($link,"SELECT *FROM contestant where gender = 'Male' and candidate_no = 5 ORDER BY candidate_no ASC,gender ASC");
					  		$temp;
							$num2 = 0;
				 			$modal = 0;
							$judge = $_SESSION['login_judge'];
										  ...
										  <img class='align-self-start mr-3' src='img/candidates/$picture' height='320px' alt='Generic placeholder image'>
											...
											<div class='media col-md-12 my-4'>
												<div class='media-body'>
													...
													$sql1 = mysqli_query($link,"SELECT *FROM score_card WHERE name_contestant = '$full_name' AND name_judge = '$judge' and id_contestant = 5");
