...
<html lang="en">
  <head>
    ...
    <title>Talent Portion | Male (Audience Impact 10pts)</title>
        ...
        <div class="container">
								<?php
										...
										$link = mysqli_connect("localhost","root","","tabulation");
											...
											$judge = $_SESSION['login_judge'];
											$sql5 = mysqli_query($link,"SELECT  * from score_card where name_judge = '$judge' and gender = 'Male' GROUP BY talent_portion_audience_impact_vote ORDER BY talent_portion_audience_impact_vote ASC LIMIT 1");
		      ...
		      <h3 class="jumbotron-heading" style="font-family: 'Livvic', sans-serif;">Talent Portion (100pts)</h3>
		        <p style="font-family: OCR A">CRITERIA:
							<ul>
								...
								<li>
									<a href="talent_night_uniqueness_Male.php" style="color: black;font-family: 'Livvic', sans-serif;"> Uniqueness (30pts) | Male</a>
								</li>
								<li class="active">
									<a href="talent_night_audience_impact_Male.php" style="color: red;font-family: 'Livvic', sans-serif;"><i class="fa fa-arrow-right" style="margin-left: -18px"></i> Audience Impact (10pts) | Male</a>
								</li>
							</ul>
						</p>
        </div>
