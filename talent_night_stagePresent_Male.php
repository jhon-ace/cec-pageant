	...
	else
	{
      ...
      echo "<script type='text/javascript'>alert('$message'); window.location.assign('sports_wear.php')</script>";
			...
			if(isset($_POST['submit_edit_score']))
			{
				...
				$talent_stagePresent_edit = $_POST['talent_stagePresent_edit'];

					if($talent_stagePresent_edit == 0)
					{
							$updateScoreCard = "UPDATE score_card SET talent_portion_stagePresent = '$edit_scoreInput',talent_portion_stagePresent_vote = '1', talent_portion_stagePresent_edit = '1' WHERE name_contestant = '$edit_name_contestant' AND name_judge = '$judge_session'";
								mysqli_query($link,$updateScoreCard);

							$sql_talent_stagePresent_editScore = "UPDATE talent_portion SET stage_present = '$edit_scoreInput' WHERE name = '$edit_name_contestant' and name_judge = '$judge_session'";
							mysqli_query($link,$sql_talent_stagePresent_editScore);

					}
					else
					{
						echo '<script>alert("YOU CAN\'T UPDATE TWICE");window.location.assign("talent_night_stagePresent.php")</script>';
				}
			}

//////////////````````````````````````````` MASTERY ```````````````````````````````````````````````````````````///////

if(isset($_POST['submit_score_mastery']))
{
	...
	$judge = $_POST['judge'];
	$name_contestant = $_POST['name_contestant'];
	$id_contestant = $_POST['submit_score_mastery'];


	if($score <101)
	{
	
		$update = "UPDATE score_card SET talent_portion_mastery = '$score',talent_portion_mastery_vote = '1' WHERE name_contestant = '$name_contestant' AND name_judge = '$judge'";
		mysqli_query($link,$update);
...
//x
				$sql_talent_portion_mastery_updateByJudgeName = "UPDATE talent_portion SET mastery = '$score' WHERE name = '$name_contestant' and name_judge = '$judge_session'";
				mysqli_query($link,$sql_talent_portion_mastery_updateByJudgeName);
	...
	else
	{
      ...
      echo "<script type='text/javascript'>alert('$message'); window.location.assign('sports_wear.php')</script>";
			...
			if(isset($_POST['submit_edit_score_mastery']))
			{
				...
				$edit_judge = $_POST['edit_judge'];
				$edit_name_contestant = $_POST['edit_name_contestant'];
				$talent_mastery_edit = $_POST['talent_mastery_edit'];

					if($talent_mastery_edit == 0)
					{
							$updateScoreCard = "UPDATE score_card SET talent_portion_mastery = '$edit_scoreInput',talent_portion_mastery_vote = '1', talent_portion_mastery_edit = '1' WHERE name_contestant = '$edit_name_contestant' AND name_judge = '$judge_session'";
								mysqli_query($link,$updateScoreCard);

							$sql_talent_mastery_editScore = "UPDATE talent_portion SET mastery = '$edit_scoreInput' WHERE name = '$edit_name_contestant' and name_judge = '$judge_session'";
							mysqli_query($link,$sql_talent_mastery_editScore);
...
if(isset($_POST['submit_score_uniqueness']))
{
	...
	$judge = $_POST['judge'];
	$name_contestant = $_POST['name_contestant'];
	$id_contestant = $_POST['submit_score_uniqueness'];


	if($score <101)
	{
	
		$update = "UPDATE score_card SET talent_portion_uniqueness = '$score',talent_portion_uniqueness_vote = '1' WHERE name_contestant = '$name_contestant' AND name_judge = '$judge'";
		mysqli_query($link,$update);
...
//x
				$sql_talent_portion_uniqueness_updateByJudgeName = "UPDATE talent_portion SET uniqueness = '$score' WHERE name = '$name_contestant' and name_judge = '$judge_session'";
				mysqli_query($link,$sql_talent_portion_uniqueness_updateByJudgeName);
	...
	else
	{
      ...
      echo "<script type='text/javascript'>alert('$message'); window.location.assign('sports_wear.php')</script>";
			...
			if(isset($_POST['submit_edit_score_uniqueness']))
			{
				$judge_session = $_SESSION['login_judge'];
				$edit_scoreInput = $_POST['edit_scoreInput'];
				$edit_judge = $_POST['edit_judge'];
				$edit_name_contestant = $_POST['edit_name_contestant'];
				$talent_uniqueness_edit = $_POST['talent_uniqueness_edit'];

					if($talent_uniqueness_edit == 0)
					{
							$updateScoreCard = "UPDATE score_card SET talent_portion_uniqueness = '$edit_scoreInput',talent_portion_uniqueness_vote = '1', talent_portion_uniqueness_edit = '1' WHERE name_contestant = '$edit_name_contestant' AND name_judge = '$judge_session'";
								mysqli_query($link,$updateScoreCard);

							$sql_talent_uniqueness_editScore = "UPDATE talent_portion SET uniqueness = '$edit_scoreInput' WHERE name = '$edit_name_contestant' and name_judge = '$judge_session'";
							mysqli_query($link,$sql_talent_uniqueness_editScore);
	...
	//`````````````````````````````````` AUDIENCE IMPACT ``````````````````````````````````````````````````//
			...
			if(isset($_POST['submit_score_audience_impact']))
{
	...
	$judge = $_POST['judge'];
	$name_contestant = $_POST['name_contestant'];
	$id_contestant = $_POST['submit_score_audience_impact'];
...
<html lang="en">
  <head>
    ...
    <title>Talent Portion | Male (Stage Present 20pts)</title>
        ...
        <div class="container">
								<?php
										...
										$link = mysqli_connect("localhost","root","","tabulation");
											...
											$judge = $_SESSION['login_judge'];
											$sql5 = mysqli_query($link,"SELECT  * from score_card where name_judge = '$judge' and gender = 'Male'  order BY talent_portion_stagePresent_vote ASC,talent_portion_audience_impact_vote ASC, talent_portion_mastery ASC, talent_portion_audience_impact_vote ASC ");
												...
												for($b = 0 ; $b < $num_rowst = mysqli_fetch_array($sql5) ; $b++ )
													{	
														...
														if($name_judgeD == $judge)
														{
															...
															$talent_portion_mastery_vote = $num_rowst['talent_portion_mastery_vote'];
															$talent_portion_uniqueness_vote = $num_rowst['talent_portion_uniqueness_vote'];
															$talent_portion_audience_impact_vote = $num_rowst['talent_portion_audience_impact_vote'];

																if($talent_portion_stagePresent_vote == 0 && $talent_portion_mastery_vote == 0 &&  $talent_portion_uniqueness_vote == 0 && $talent_portion_audience_impact_vote == 0)
																	{
        ...
        <div class="container">
		      <h3 class="jumbotron-heading" style="font-family: 'Livvic', sans-serif;">Talent Portion (100pts)</h3>
		        <p style="font-family: OCR A">CRITERIA:
							<ul>
								<li class="active">
										<a href="" style="font-family: 'Livvic', sans-serif;"><i class="fa fa-arrow-right" style="margin-left: -18px"></i> Stage Present (20pts) | Male</a><br>
								</li>
								<li><a href="talent_night_mastery_Male" style="color: black;font-family: 'Livvic', sans-serif;" onMouseOver="this.style.color='red'" onMouseOut="this.style.color='black'">Mastery (40pts) | Male</a></li>
								<li><a href="talent_night_uniqueness_Male.php" style="color: black;font-family: 'Livvic', sans-serif;" onMouseOver="this.style.color='red'" onMouseOut="this.style.color='black'">Uniqueness (30pts) | Male</a></li>
								<li><a href="talent_night_audience_impact_Male.php" style="color: black;font-family: 'Livvic', sans-serif;" onMouseOver="this.style.color='red'" onMouseOut="this.style.color='black'">Audience Impact (10pts) | Male</a></li>
							</ul>
						</p>
        </div>
      </section>
...
<!--        CANDIDATE NO. 1 IN SEQUENCE --->
	          ...
	          <div class="row">
				  		<?php
							...
							$sql = mysqli_query($link,"SELECT * FROM contestant where gender = 'Male' and talent_portion_sequenceNo = 1 order by gender DESC, talent_portion_sequenceNo ASC");
					  		$temp;
							$num2 = 0;
				 			$modal = 0;
							$judge = $_SESSION['login_judge'];
										...
										<div class='media-body'>
										  <img class='align-self-start mr-3' src='img/candidates/$picture' height='300px' alt='Generic placeholder image'>
											...
											<div class='media col-md-12 my-4'>
												<div class='media-body'>
													<h5 class='mt-0' style='font-family:OCR A'>Candidate <text style='color:red'><b>#$sequence_no</b></text> - <text style='color:red'><b>$team</b></text></h5>
													...
													for($b = 0 ; $b < $num_rows1 = mysqli_fetch_array($sql1) ; $b++ )
													{
														...
														if($name_judge == $judge)
														{
															$talent_portion_stagePresent_edit = $num_rows1['talent_portion_stagePresent_edit'];
															$talent_portion_stagePresent_vote = $num_rows1['talent_portion_stagePresent_vote'];
															if($talent_portion_stagePresent_vote == 0)
															{
													echo "
													<p><b style='font-family: Arial Rounded MT;font-size: 16px'><text style='color:red'>*</text> STAGE PRESENT (20pts) *</b></p>
											...
											<div class='col-md-6 col-lg-7' style='margin-top:-12px'>
												<table>
													<tr>
														...
														<td style='display:none'>$talent_portion_stagePresent</td>
														<td style='display:none'>$judge</td>
														<td style='display:none'>$full_name</td>
														<td style='display:none'>$candidate_no</td>
														<td style='display:none'>$team</td>
														<td style='display:none'>$talent_portion_stagePresent_edit</td>
														<td style='display:none'>$sequence_no</td>
													";
													if($talent_portion_stagePresent_edit == 0)
													{
											...
											echo "		
														<td>
															...
															<p><b style='font-family: Arial Rounded MT;font-size: 16px'><text style='color:red'>*</text> STAGE PRESENT (20pts) *</b></p>
																...
																<span class='editScore text-success' style='text-decoration:none;color: black;'><i class='fa fa-star' style='font-size:14px'></i> <text style='font-family:Century Gothic'>Score: $talent_portion_stagePresent</text></span><br>
											...
											<div class='media col-md-12 my-4'>
												<div class='media-body'>
													...
													for($b = 0 ; $b < $num_rows1 = mysqli_fetch_array($sql1) ; $b++ )
													{
														$id_contestant1 = $num_rows1['id_contestant'];
														$name_judge = $num_rows1['name_judge'];
														$talent_portion_mastery = $num_rows1['talent_portion_mastery'];
														
														if($name_judge == $judge)
														{
															$talent_portion_mastery_edit = $num_rows1['talent_portion_mastery_edit'];
															$talent_portion_mastery_vote = $num_rows1['talent_portion_mastery_vote'];
															if($talent_portion_mastery_vote == 0)
															{
													echo "
													<p><b style='font-family: Arial Rounded MT;font-size: 16px'><text style='color:red'>*</text> MASTERY (40pts) *</b></p>
													<div class = 'col-md-6 col-lg-4 my-7'>
														<form method = 'post'>
															<div class='input-group mb-3'>
															  <input type='number' min='1' max = '40' class='form-control' placeholder='Score' aria-label='Recipient's username' aria-describedby='button-addon2' name = 'score' required maxlength='2' pattern='[0-9]{1,}'>
															  <input type = 'hidden' name ='judge' value='$judge'>
															  <input type = 'hidden' name ='name_contestant' value='$full_name'>
																  <div class='input-group-append'>
																	&nbsp<button class='btn btn-primary'  type='button' data-toggle='modal' data-target='#exampleModal$modal' >Submit Score</button>
												...
												<div class='modal fade' id='exampleModal$modal' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' aria-hidden='true'>
													<div class='modal-dialog' role='document'>
														...
														<div class='modal-footer'>
															<button class='btn btn-secondary' type='button' data-dismiss='modal'>Cancel</button>
																<button class = 'btn btn-danger' name = 'submit_score_mastery' id='button-addon2'
																										value = '$id_contestant'>Submit</button>
										...
										else
										{
											...
											<div class='col-md-6 col-lg-7' style='margin-top:-12px'>
												<table>
													<tr>
														<td style='display:none'>$full_name</td>
														<td style='display:none'>$talent_portion_mastery</td>
														<td style='display:none'>$judge</td>
														<td style='display:none'>$full_name</td>
														<td style='display:none'>$candidate_no</td>
														<td style='display:none'>$team</td>
														<td style='display:none'>$talent_portion_mastery_edit</td>
														<td style='display:none'>$sequence_no</td>
													";
													if($talent_portion_mastery_edit == 0)
													{
											...
											echo "		
														<td>
															...
															<p><b style='font-family: Arial Rounded MT;font-size: 16px'><text style='color:red'>*</text> MASTERY (40pts) *</b></p>
																<span style = 'color:red;font-family:Calibri'>Your score has been recorded for this contestant!</span><br>
																<span class='editScore text-success' style='text-decoration:none;color: black;'><i class='fa fa-star' style='font-size:14px'></i> <text style='font-family:Century Gothic'>Score: $talent_portion_mastery</text></span><br>
											...
											<div class='media col-md-12 my-4'>
												<div class='media-body'>
													...
													for($b = 0 ; $b < $num_rows1 = mysqli_fetch_array($sql1) ; $b++ )
													{
														$id_contestant1 = $num_rows1['id_contestant'];
														$name_judge = $num_rows1['name_judge'];
														$talent_portion_uniqueness = $num_rows1['talent_portion_uniqueness'];
														
														if($name_judge == $judge)
														{
															$talent_portion_uniqueness_edit = $num_rows1['talent_portion_uniqueness_edit'];
															$talent_portion_uniqueness_vote = $num_rows1['talent_portion_uniqueness_vote'];
															if($talent_portion_uniqueness_vote == 0)
															{
													echo "
													<p><b style='font-family: Arial Rounded MT;font-size: 16px'><text style='color:red'>*</text> UNIQUENESS (30pts) *</b></p>
													<div class = 'col-md-6 col-lg-4 my-7'>
														<form method = 'post'>
															<div class='input-group mb-3'>
															  <input type='number' min='1' max = '30' class='form-control' placeholder='Score' aria-label='Recipient's username' aria-describedby='button-addon2' name = 'score' required maxlength='2' pattern='[0-9]{1,}'>
															  <input type = 'hidden' name ='judge' value='$judge'>
															  <input type = 'hidden' name ='name_contestant' value='$full_name'>
																  <div class='input-group-append'>
																	&nbsp<button class='btn btn-primary'  type='button' data-toggle='modal' data-target='#exampleModal$modal' >Submit Score</button>
												...
												<div class='modal fade' id='exampleModal$modal' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' aria-hidden='true'>
													<div class='modal-dialog' role='document'>
														...
														<div class='modal-footer'>
															<button class='btn btn-secondary' type='button' data-dismiss='modal'>Cancel</button>
																<button class = 'btn btn-danger' name = 'submit_score_uniqueness' id='button-addon2'
																										value = '$id_contestant'>Submit</button>
										...
										else
										{
											...
											<div class='col-md-6 col-lg-7' style='margin-top:-12px'>
												<table>
													<tr>
														<td style='display:none'>$full_name</td>
														<td style='display:none'>$talent_portion_uniqueness</td>
														<td style='display:none'>$judge</td>
														<td style='display:none'>$full_name</td>
														<td style='display:none'>$candidate_no</td>
														<td style='display:none'>$team</td>
														<td style='display:none'>$talent_portion_uniqueness_edit</td>
														<td style='display:none'>$sequence_no</td>
													";
													if($talent_portion_uniqueness_edit == 0)
													{
											...
											echo "		
														<td>
															...
															<p><b style='font-family: Arial Rounded MT;font-size: 16px'><text style='color:red'>*</text> UNIQUENESS (30pts) *</b></p>
																<span style = 'color:red;font-family:Calibri'>Your score has been recorded for this contestant!</span><br>
																<span class='editScore text-success' style='text-decoration:none;color: black;'><i class='fa fa-star' style='font-size:14px'></i> <text style='font-family:Century Gothic'>Score: $talent_portion_uniqueness</text></span><br>
														  <a href='' class='editScore_uniqueness' data-toggle='modal' data-target='#editScoreModalUniqueness' style='text-decoration:none;color: black'><span class='btn my-2 btn-outline-secondary'><i class='fa fa-pencil-square-o'> <text style='font-family:Century Gothic'>Edit Score</text></i></span></a>
															</center>
														</td>
													";
													}
							...
							for($a = 0 ; $a < $num_rows = mysqli_fetch_array($sql) ; $a++ )
									{
											...
											<div class='media col-md-12 my-4'>
												<div class='media-body'>
													...
													for($b = 0 ; $b < $num_rows1 = mysqli_fetch_array($sql1) ; $b++ )
													{
														...
														if($name_judge == $judge)
														{
															...
															{
													echo "
													<p><b style='font-family: Arial Rounded MT;font-size: 16px'><text style='color:red'>*</text> AUIDENCE IMPACT (10pts) *</b></p>
													<div class = 'col-md-6 col-lg-4 my-7'>
														<form method = 'post'>
															<div class='input-group mb-3'>
												...
												<div class='modal fade' id='exampleModal$modal' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' aria-hidden='true'>
													<div class='modal-dialog' role='document'>
														...
														<div class='modal-footer'>
															<button class='btn btn-secondary' type='button' data-dismiss='modal'>Cancel</button>
																<button class = 'btn btn-danger' name = 'submit_score_audience_impact' id='button-addon2'
																										value = '$id_contestant'>Submit</button>
										...
										else
										{
											...
											echo "		
														<td>
															<center>
															<p><b style='font-family: Arial Rounded MT;font-size: 16px'><text style='color:red'>*</text> AUDIENCE IMPACT (10pts) *</b></p>
																<span style = 'color:red;font-family:Calibri'>Your score has been recorded for this contestant!</span><br>
...
<!-------------------------------------------------------------------------------------------------------------------->
	          ...
	          <div class="row">
				  		<?php
							...
							$sql = mysqli_query($link,"SELECT * FROM contestant where gender = 'Male' and talent_portion_sequenceNo = 2 order by gender DESC, talent_portion_sequenceNo ASC");
					  		$temp;
							$num2 = 0;
				 			$modal = 0;
							$judge = $_SESSION['login_judge'];
...
<!-------------------------------------------------------------------------------------------------------------------->
	          ...
	          <div class="row">
				  		<?php
							...
							$sql = mysqli_query($link,"SELECT * FROM contestant where gender = 'Male' and talent_portion_sequenceNo = 3 order by gender DESC, talent_portion_sequenceNo ASC");
					  		$temp;
							$num2 = 0;
				 			$modal = 0;
							$judge = $_SESSION['login_judge'];
...
<form method="post">
						<div class='modal fade' id='editScoreModal' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel'           aria-hidden='true'>
							<div class='modal-dialog' role='document'>
								<div class='modal-content'>
									...
									<div class='modal-body'>
										<h6 style="font-family: 'Livvic', sans-serif;font-weight: bold;">Stage Presents (20pts)</h6><p></p>
										<p style="font-family: 'Livvic', sans-serif;color:red">Note: You can only update once.</p>
										  ...
										  <text style="font-family: 'Livvic', sans-serif;">Contestant Team:</text> <input type="text" id = "team" class="re"readonly disabled/><br>
											...
											<input type="text" id="talent_stagePresent_edit" name="talent_stagePresent_edit" class="re" readonly hidden />
											...
											<text style="font-family: 'Livvic', sans-serif;">New Score:</text> <input type="number" min="1" max="20" name="edit_scoreInput" class="red" required aria-describedby='button-addon3'/>
									</div>
									<div class='modal-footer'>
		...
		<script type="text/javascript">
                ...
                $('.editScore').on('click', function () {
                    ...
                    $('#team').val(data[5]);
                    $('#talent_stagePresent_edit').val(data[6]);
...
<form method="post">
						<div class='modal fade' id='editScoreModalMastery' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabelf'           aria-hidden='true'>
							<div class='modal-dialog' role='document'>
								<div class='modal-content'>
									<div class='modal-header'>
										<h5 class='modal-title' id='exampleModalLabel' style="font-family: 'Livvic', sans-serif;">Edit Score</h5><br>
									...
									<div class='modal-body'>
										<h6 style="font-family: 'Livvic', sans-serif;font-weight: bold;">Mastery (40pts)</h6><p></p>
										<p style="font-family: 'Livvic', sans-serif;color:red">Note: You can only update once.</p>
										
										  <text style="font-family: 'Livvic', sans-serif;">Contestant Number:</text> <input type="text" id = "sequence_no_mastery" class="re"readonly disabled /><br>
										  <text style="font-family: 'Livvic', sans-serif;">Contestant Team:</text> <input type="text" id = "team_mastery" class="re"readonly disabled/><br>
											<text style="font-family: 'Livvic', sans-serif;">Contestant Name:</text> <input type="text" id = "name_contestant_mastery" name="edit_name_contestant" class="re"readonly style="cursor:auto;" /><br><br>
											<input type="text" id="talent_mastery_edit_mastery" name="talent_mastery_edit" class="re" readonly hidden />
											<text style="font-family: 'Livvic', sans-serif;">Submitted Score:</text> <input type="number" id = "initial_score_mastery" class="re"readonly disabled/><br>
											<input type="text" id = "judge_mastery" name="edit_judge" class="re"readonly hidden /><br>
											<text style="font-family: 'Livvic', sans-serif;">New Score:</text> <input type="number" min="1" max="40" name="edit_scoreInput" class="red" required aria-describedby='button-addon3'/>
									</div>
									<div class='modal-footer'>

																		<button class='btn btn-secondary' type='button' data-dismiss='modal' style="font-family: 'Livvic', sans-serif;">Cancel</button>
																		<button class = 'btn btn-danger' type='submit' name ='submit_edit_score_mastery' id='button-addon3' style="font-family: 'Livvic', sans-serif;">Enter</button>
		...
		<script type="text/javascript">
                ...
                $('.editScore_mastery').on('click', function () {
                    ...
                    console.log(data);
                    $('#initial_score_mastery').val(data[1]);
                    $('#judge_mastery').val(data[2]);
                    $('#name_contestant_mastery').val(data[3]);
                    $('#id_contestant_mastery').val(data[4]);
                    $('#team_mastery').val(data[5]);
                    $('#talent_mastery_edit_mastery').val(data[6]);
                    $('#sequence_no_mastery').val(data[7]);
...
<form method="post">
						<div class='modal fade' id='editScoreModalUniqueness' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel'           aria-hidden='true'>
							<div class='modal-dialog' role='document'>
								<div class='modal-content'>
									<div class='modal-header'>
										<h5 class='modal-title' id='exampleModalLabel' style="font-family: 'Livvic', sans-serif;">Edit Score</h5><br>
									...
									<div class='modal-body'>
										<h6 style="font-family: 'Livvic', sans-serif;font-weight: bold;">Uniqueness (30pts)</h6><p></p>
										<p style="font-family: 'Livvic', sans-serif;color:red">Note: You can only update once.</p>
										
										  <text style="font-family: 'Livvic', sans-serif;">Contestant Number:</text> <input type="text" id = "sequence_no_uniqueness" class="re"readonly disabled /><br>
										  <text style="font-family: 'Livvic', sans-serif;">Contestant Team:</text> <input type="text" id = "team_uniqueness" class="re"readonly disabled/><br>
											<text style="font-family: 'Livvic', sans-serif;">Contestant Name:</text> <input type="text" id = "name_contestant_uniqueness" name="edit_name_contestant" class="re"readonly style="cursor:auto;" /><br><br>
											<input type="text" id="talent_uniqueness_edit_uniqueness" name="talent_uniqueness_edit" class="re" readonly hidden />
											<text style="font-family: 'Livvic', sans-serif;">Submitted Score:</text> <input type="number" id = "initial_score_uniqueness" class="re"readonly disabled/><br>
											<input type="text" id = "judge_uniqueness" name="edit_judge" class="re"readonly hidden /><br>
											<text style="font-family: 'Livvic', sans-serif;">New Score:</text> <input type="number" min="1" max="30" name="edit_scoreInput" class="red" required aria-describedby='button-addon3'/>
									</div>
									<div class='modal-footer'>

																		<button class='btn btn-secondary' type='button' data-dismiss='modal' style="font-family: 'Livvic', sans-serif;">Cancel</button>
																		<button class = 'btn btn-danger' type='submit' name ='submit_edit_score_uniqueness' id='button-addon3' style="font-family: 'Livvic', sans-serif;">Enter</button>
...
<script type="text/javascript">
			      $(document).ready(function () {
                $('.editScore_uniqueness').on('click', function () {
                    ...
                    console.log(data);
                    $('#initial_score_uniqueness').val(data[1]);
                    $('#judge_uniqueness').val(data[2]);
                    $('#name_contestant_uniqueness').val(data[3]);
                    $('#id_contestant_uniqueness').val(data[4]);
                    $('#team_uniqueness').val(data[5]);
                    $('#talent_uniqueness_edit_uniqueness').val(data[6]);
                    $('#sequence_no_uniqueness').val(data[7]);
...
<form method="post">
						<div class='modal fade' id='editScoreModalAudience_Impact' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel'           aria-hidden='true'>
							<div class='modal-dialog' role='document'>
								<div class='modal-content'>
									...
									<div class='modal-body'>
										<h6 style="font-family: 'Livvic', sans-serif;font-weight: bold;">Audience Impact (10pts)</h6><p></p>
										<p style="font-family: 'Livvic', sans-serif;color:red">Note: You can only update once.</p>
										
										  <text style="font-family: 'Livvic', sans-serif;">Contestant Number:</text> <input type="text" id = "sequence_no_audience_impact" class="re"readonly disabled /><br>
										  <text style="font-family: 'Livvic', sans-serif;">Contestant Team:</text> <input type="text" id = "team_audience_impact" class="re"readonly disabled/><br>
											<text style="font-family: 'Livvic', sans-serif;">Contestant Name:</text> <input type="text" id = "name_contestant_audience_impact" name="edit_name_contestant" class="re"readonly style="cursor:auto;" /><br><br>
											<input type="text" id="talent_audience_impact_edit_audience_impact" name="talent_audience_impact_edit" class="re" readonly hidden />
											<text style="font-family: 'Livvic', sans-serif;">Submitted Score:</text> <input type="number" id = "initial_score_audience_impact" class="re"readonly disabled/><br>
											<input type="text" id = "judge_audience_impact" name="edit_judge" class="re"readonly hidden /><br>
									...
									<div class='modal-footer'>
																		...
																		<button class='btn btn-secondary' type='button' data-dismiss='modal' style="font-family: 'Livvic', sans-serif;">Cancel</button>
																		<button class = 'btn btn-danger' type='submit' name ='submit_edit_score_audience_impact' id='button-addon3' style="font-family: 'Livvic', sans-serif;">Enter</button>
		...
		<script type="text/javascript">
                ...
                $('.editScore_audience_impact').on('click', function () {
                    ...
                    console.log(data);
                    $('#initial_score_audience_impact').val(data[1]);
                    $('#judge_audience_impact').val(data[2]);
                    $('#name_contestant_audience_impact').val(data[3]);
                    $('#id_contestant_audience_impact').val(data[4]);
                    $('#team_audience_impact').val(data[5]);
                    $('#talent_audience_impact_edit_audience_impact').val(data[6]);
                    $('#sequence_no_audience_impact').val(data[7]);
