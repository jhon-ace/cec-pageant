...
<html lang="en">
  <head>
    ...
    <title>Talent Portion | Male (Mastery 40pts)</title>
        ...
        <div class="container">
								<?php
										...
										$link = mysqli_connect("localhost","root","","tabulation");
											...
											$judge = $_SESSION['login_judge'];
											$sql5 = mysqli_query($link,"SELECT  * from score_card where name_judge = '$judge' and gender = 'Male' GROUP BY talent_portion_mastery_vote ORDER BY talent_portion_mastery_vote ASC LIMIT 1");
		      ...
		      <h3 class="jumbotron-heading" style="font-family: 'Livvic', sans-serif;">Talent Portion (100pts)</h3>
		        <p style="font-family: OCR A">CRITERIA:
							<ul>
								...
								<li class="active">
									<a href="" style="color: red;font-family: 'Livvic', sans-serif;"><i class="fa fa-arrow-right" style="margin-left: -18px"></i> Mastery (40pts) | Male</a>
								</li>
								<li>
									<a href="talent_night_uniqueness_Male.php" style="color: black;font-family: 'Livvic', sans-serif;" onMouseOver="this.style.color='red'" onMouseOut="this.style.color='black'">Uniqueness (30pts) | Male</a>
								</li>
								<li>
													...
													<div class = 'col-md-6 col-lg-4 my-7'>
														<form method = 'post'>
															<div class='input-group mb-3'>
															  <input type='number' min='1' max = '40' class='form-control' placeholder='Example Score: 40' aria-label='Recipient's username' aria-describedby='button-addon2' name = 'score' required maxlength='2' pattern='[0-9]{1,}'>
...
<form method="post">
						<div class='modal fade' id='editScoreModal' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel'           aria-hidden='true'>
							<div class='modal-dialog' role='document'>
								<div class='modal-content'>
									...
									<div class='modal-body'>
										<h6 style="font-family: 'Livvic', sans-serif;font-weight: bold;">Mastery | Male (40pts)</h6><p></p>
										<p style="font-family: 'Livvic', sans-serif;color:red">Note: You can only update once.</p>
										  ...
										  <text style="font-family: 'Livvic', sans-serif;">Contestant Team:</text> <input type="text" id = "team" class="re"readonly disabled/><br>
											...
											<input type="text" id="talent_mastery_edit" name="talent_mastery_edit" class="re" readonly hidden />
		...
		<script type="text/javascript">
                ...
                $('.editScore').on('click', function () {
                    ...
                    $('#team').val(data[5]);
                    $('#talent_mastery_edit').val(data[6]);
