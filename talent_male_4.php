        ...
        <div class="container">
								<?php
										$link = mysqli_connect("localhost","root","","tabulation");
											...
											$judge = $_SESSION['login_judge'];
											$sql5 = mysqli_query($link,"SELECT  * from score_card where name_judge = '$judge' and gender = 'Male' and id_contestant = 6 GROUP BY talent_portion_audience_impact_vote ORDER BY talent_portion_audience_impact_vote DESC LIMIT 1");
		      ...
		      <h3 class="jumbotron-heading">TALENT PORTION (100%) | MALE</h3>
		        <p>CRITERIA:
							...
							<ul style="list-style-type: none;font-size: 18px !important;">
								...
								<li class="active" style="display: inline;padding-right: 15px;font-family: Arial"><a href="talent_male_4.php"><b># 4</b></a></li>
						<?php 
														...
														if($name_judgeD == $judge)
														{
															$talent_portion_audience_impact_vote = $num_rowst['talent_portion_audience_impact_vote'];
																...
																if($talent_portion_audience_impact_vote == 0)
																	...
																	{
																		echo '<li  style="display: inline;padding-right: 15px"><a class="linkage" href="talent_male_5.php" style="color:black;font-family: Arial"># 5</a></li>';
	        ...
	        <center>
	          <div class="row">
				  		<?php
							...
							$sql = mysqli_query($link,"SELECT *FROM contestant where gender = 'Male' and talent_portion_sequenceNo = 4 ORDER BY candidate_no ASC,gender ASC");
					  		$temp;
							$num2 = 0;
				 			$modal = 0;
							$judge = $_SESSION['login_judge'];
										  ...
										  <img class='align-self-start mr-3' src='img/candidates/$picture' height='320px' alt='Generic placeholder image'>
											...
											<div class='media col-md-12 my-4'>
												<div class='media-body'>
													...
													$sql1 = mysqli_query($link,"SELECT *FROM score_card WHERE name_contestant = '$full_name' and gender = 'Male' AND name_judge = '$judge' and id_contestant = 6");
...
<!-- -----------------------------------    UNIQUENESS        ----------------------------------------------->
						...
						<div class="row">
				  		<?php
							...
							$sql = mysqli_query($link,"SELECT *FROM contestant where gender = 'Male' and talent_portion_sequenceNo = 4 ORDER BY talent_portion_sequenceNo ASC,gender ASC");
					  		$temp;
							$num2 = 0;
				 			$modal = 0;
							$judge = $_SESSION['login_judge'];
