        ...
        <div class="container">
								<?php
										...
										$link = mysqli_connect("localhost","root","","tabulation");
											...
											$judge = $_SESSION['login_judge'];
											$sql5 = mysqli_query($link,"SELECT  * from score_card where name_judge = '$judge' and gender = 'Male' GROUP BY talent_portion_stagePresent_vote ORDER BY talent_portion_stagePresent_vote ASC LIMIT 1");
											...
											<div class='media col-md-12 my-4'>
												<div class='media-body'>
													...
													<div class = 'col-md-6 col-lg-4 my-7'>
														<form method = 'post'>
																													<span>Stage Present</span>
															<div class='input-group mb-3'>
															  <input type='number' min='1' max = '20' class='form-control' placeholder='Score for Stage Present' aria-label='Recipient's username' aria-describedby='button-addon2' name = 'score' required maxlength='2' pattern='[0-9]{1,}'>
