...
<html lang="en">
  <head>
    ...
    <title>Talent Portion | Female (Mastery 40pts)</title>
        ...
        <div class="container">
								<?php
										...
										$link = mysqli_connect("localhost","root","","tabulation");
											...
											$judge = $_SESSION['login_judge'];
											$sql5 = mysqli_query($link,"SELECT  * from score_card where name_judge = '$judge' and gender = 'Female' GROUP BY talent_portion_mastery_vote ORDER BY talent_portion_mastery_vote ASC LIMIT 1");
		      ...
		      <h3 class="jumbotron-heading" style="font-family: 'Livvic', sans-serif;">Talent Portion (100pts)</h3>
		        <p style="font-family: OCR A">CRITERIA:
							<ul>
								...
								<li class="active">
									<a href="talent_night_mastery_Female.php" style="color: red;font-family: 'Livvic', sans-serif;"><i class="fa fa-arrow-right" style="margin-left: -18px"></i> Mastery (40pts) | Female</a>
								</li>
								<li>
									<a href="talent_night_uniqueness_Female.php" style="color: black;font-family: 'Livvic', sans-serif;" onMouseOver="this.style.color='red'" onMouseOut="this.style.color='black'">Uniqueness (30pts) | Female</a>
								</li>
								<li>
									<a href="talent_night_audience_impact_Female.php" style="color: black;font-family: 'Livvic', sans-serif;" onMouseOver="this.style.color='red'" onMouseOut="this.style.color='black'">Audience Impact (10pts) | Female</a>
								</li>
							</ul>
						</p>
        </div>
						...
						<div class='modal fade' id='editScoreModal' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel'           aria-hidden='true'>
							<div class='modal-dialog' role='document'>
								<div class='modal-content'>
									...
									<div class='modal-body'>
										<h6 style="font-family: 'Livvic', sans-serif;font-weight: bold;">Mastery | Female (40pts)</h6><p></p>
