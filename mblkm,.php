...
<html lang="en">
  <head>
    ...
    <title>Production Number | Poise and Bearing(30pts)</title>
  ...
  <body>
        ...
        <div class="container">
								<?php
										$link = mysqli_connect("localhost","root","","tabulation");
											...
											$judge = $_SESSION['login_judge'];
											$sql5 = mysqli_query($link,"SELECT  * from score_card where name_judge = '$judge'  GROUP BY production_PoiseandBearing_vote ORDER BY production_PoiseandBearing_vote ASC LIMIT 1");
												...
												for($b = 0 ; $b < $num_rowst = mysqli_fetch_array($sql5) ; $b++ )
													{	
														...
														{
															$production_PoiseandBearing_vote = $num_rowst['production_PoiseandBearing_vote'];
    ...
    <main role="main">
      <section class="jumbotron jumbotron-fluid text-left py-4">
        <div class="container">
		      <h3 class="jumbotron-heading">Production Number (100%)</h3>
		        <p>CRITERIA:
							<ul>
								<li class="active"><a href="production_poiseBearing.php"><i class="fa fa-arrow-right" style="margin-left: -18px"></i> Poise and Bearing (30pts)</a></li>
								<li><a href="production_mastery.php" style="color: black;" onMouseOver="this.style.color='red'" onMouseOut="this.style.color='black'">Mastery (30pts)</a></li>
								<li><a href="production_self_introduction.php" style="color: black;" onMouseOver="this.style.color='red'" onMouseOut="this.style.color='black'">Self-Introduction (30pts)</a></li>
								<li><a href="production_audience_impact.php" style="color: black;" onMouseOver="this.style.color='red'" onMouseOut="this.style.color='black'">Audience Impact (10)</a></li>
							</ul>
							<ul style="list-style-type: none;">
								<li style="display: inline;padding-right: 15px">Candidate:</li>
								<li style="display: inline;padding-right: 15px"><a href=""># 1</a></li>
								<li  style="display: inline;padding-right: 15px"><a href=""># 2</a></li>
								<li  style="display: inline;padding-right: 15px"><a href=""># 3</a></li>
								<li  style="display: inline;padding-right: 15px"><a href=""># 4</a></li>
								<li  style="display: inline;padding-right: 15px"><a href=""># 5</a></li>
								<li  style="display: inline;padding-right: 15px"><a href=""># 6</a></li>
							</ul>
						</p>
        </div>
      </section>
...
<form method="post">
									...
									<div class='modal-body'>
										...
										<p style="color:red;">Note: You can only update once.</p>
										  ...
										  Contestant Team: <input type="text" id = "team" class="re"readonly disabled/><br>
											...
											<input type="text" id="production_PoiseandBearing" name="production_PoiseandBearing" class="re"readonly hidden />
		...
		<script type="text/javascript">
                ...
                $('.editScore').on('click', function () {
                    ...
                    $('#team').val(data[5]);
                    $('#production_PoiseandBearing').val(data[6]);
