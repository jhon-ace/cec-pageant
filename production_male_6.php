        ...
        <div class="container">
								<?php
										$link = mysqli_connect("localhost","root","","tabulation");
											...
											$judge = $_SESSION['login_judge'];
											$sql5 = mysqli_query($link,"SELECT  * from score_card where name_judge = '$judge' and id_contestant = 6 GROUP BY production_audience_impact_vote ORDER BY production_audience_impact_vote DESC LIMIT 1");
		      ...
		      <h3 class="jumbotron-heading">Production Number (100%) | MALE</h3>
		        <p>CRITERIA:
							...
							<ul style="list-style-type: none;font-size: 18px !important;">
								...
								<li style="display: inline;padding-right: 15px;font-family: Arial"><a class="linkage" href="production_male_3.php" style="color:black;" onMouseOver="this.style.color='red'" onMouseOut="this.style.color='black'"># 3</a></li>
								<li style="display: inline;padding-right: 15px;font-family: Arial"><a class="linkage" href="production_male_4.php" onMouseOver="this.style.color='red'" onMouseOut="this.style.color='black'" style="color:black;"># 4</a></li>
								<li style="display: inline;padding-right: 15px;font-family: Arial"><a class="linkage" href="production_male_5.php"  onMouseOver="this.style.color='red'" onMouseOut="this.style.color='black'" style="color:black;"># 5</a></li>
								<li class="active" style="display: inline;padding-right: 15px;font-family: Arial"><a class="linkage" href="production_male_6.php" ><b># 6</b></a></li>
								<?php 
	        ...
	        <center>
	          <div class="row">
				  		<?php
							...
							$sql = mysqli_query($link,"SELECT *FROM contestant where gender = 'Male' and candidate_no = 6 ORDER BY candidate_no ASC,gender ASC");
					  		$temp;
							$num2 = 0;
				 			$modal = 0;
							$judge = $_SESSION['login_judge'];
										  ...
										  <img class='align-self-start mr-3' src='img/candidates/$picture' height='320px' alt='Generic placeholder image'>
											...
											<div class='media col-md-12 my-4'>
												<div class='media-body'>
													...
													$sql1 = mysqli_query($link,"SELECT *FROM score_card WHERE name_contestant = '$full_name' AND name_judge = '$judge' and id_contestant = 6");
