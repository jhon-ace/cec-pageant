...
<?php
		...
		$sql5 = mysqli_query($link,"SELECT *FROM score_card WHERE name_contestant = '$full_name' AND name_judge = '$judge'");
			...
			for($b = 0 ; $b < $num_rowst = mysqli_fetch_array($sql5) ; $b++ )
				...
				if($name_judge == $judge)
				{
					$preliminary_interview_vote = $num_rowst['sports_wear_vote'];
    ...
    <main role="main">
      <section class="jumbotron jumbotron-fluid text-left py-5">
        <div class="container">
          <h2 class="jumbotron-heading">Sports Wear (100%)</h2>
          <p>CRITERIA:<br>
            Relevance to Sports (30)<br>
			Beauty and Appeal (25)<br>
			Suitability to the Wearer (20)<br>
			Stage Presence (15)<br>
			Audience Impact (10)<br>
			</p>
        </div>
      </section>
