...
<html lang="en">
  <head>
    ...
    <title>Production | Female No. 6</title>
...
-->
    ...
    <main role="main">
      <section class="jumbotron jumbotron-fluid text-left py-4">
        <div class="container">
		      <h3 class="jumbotron-heading">Production Number (100%) | <text style='color:red;font-family: Arial Rounded MT;'>FEMALE NO. 6 - CASSIOPEIA</text></h3>
		        <p>CRITERIA:
							<ul>
							...
							<ul style="list-style-type: none;font-size: 18px !important;">
								...
								<li   class="active"  style="display: inline;padding-right: 15px;font-family: Arial"><a href="production_female_6.php" ><b># 6</b></a></li>
							</ul>
						</p>
        </div>
      </section>
	        ...
	        <center>
	          <div class="row">
				  		<?php
							...
							$sql = mysqli_query($link,"SELECT *FROM contestant where gender = 'Female' and candidate_no = 6 ORDER BY candidate_no ASC,gender ASC");
					  		$temp;
							$num2 = 0;
				 			$modal = 0;
							$judge = $_SESSION['login_judge'];
