...
<html lang="en">
  <head>
    ...
    <title>Talent Portion | Male (Mastery 30pts)</title>
        ...
        <div class="container">
								<?php
										...
										$link = mysqli_connect("localhost","root","","tabulation");
											...
											$judge = $_SESSION['login_judge'];
											$sql5 = mysqli_query($link,"SELECT  * from score_card where name_judge = '$judge' and gender = 'Male' GROUP BY talent_portion_uniqueness_vote ORDER BY talent_portion_uniqueness_vote ASC LIMIT 1");
        ...
        <div class="container">
		      <h3 class="jumbotron-heading" style="font-family: 'Livvic', sans-serif;">Talent Portion (100pts)</h3>
		        <p style="font-family: OCR A">CRITERIA:
							<ul>
								<li>
										<a href="talent_night_stagePresent_Male" style="color: black;font-family: 'Livvic', sans-serif;" onMouseOver="this.style.color='red'" onMouseOut="this.style.color='black'">Stage Present (20pts) | Male</a><br>
								</li>
								<li>
									<a href="talent_night_mastery_Male.php" style="color: black;font-family: 'Livvic', sans-serif;">Mastery (40pts) | Male</a>
								</li>
								<li class="active">
									<a href="talent_night_uniqueness_Male.php" style="color: red;font-family: 'Livvic', sans-serif;"><i class="fa fa-arrow-right" style="margin-left: -18px"></i> Uniqueness (30pts) | Male</a>
								</li>
								<li>
									<a href="talent_night_audience_impact_Male.php" style="color: black;font-family: 'Livvic', sans-serif;" onMouseOver="this.style.color='red'" onMouseOut="this.style.color='black'">Audience Impact (10pts) | Male</a>
								</li>
							</ul>
						</p>
        </div>
	        ...
	        <center>
	          <div class="row">
				  		<?php
							...
							$sql = mysqli_query($link,"SELECT * FROM contestant where gender = 'Male' order by gender DESC, talent_portion_sequenceNo ASC");
					  		$temp;
							$num2 = 0;
				 			$modal = 0;
							$judge = $_SESSION['login_judge'];
										  ...
										  <img class='align-self-start mr-3' src='img/candidates/$picture' height='320px' alt='Generic placeholder image'>
											...
											<div class='media col-md-12 my-4'>
												<div class='media-body'>
													...
													<p><b style='font-family: Pristina Regular;font-size: 30px'>$status $full_name </b></p><p><b style='font-family: Arial Rounded MT;font-size: 16px'><text style='color:red'>*</text> UNIQUENESS (30pts) <text style='color:red'>*</text></b></p>";
													...
													<div class = 'col-md-6 col-lg-4 my-7'>
														<form method = 'post'>
															<div class='input-group mb-3'>
															  <input type='number' min='1' max = '30' class='form-control' placeholder='Example Score: 30' aria-label='Recipient's username' aria-describedby='button-addon2' name = 'score' required maxlength='2' pattern='[0-9]{1,}'>
...
<form method="post">
						<div class='modal fade' id='editScoreModal' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel'           aria-hidden='true'>
							<div class='modal-dialog' role='document'>
								<div class='modal-content'>
									...
									<div class='modal-body'>
										<h6 style="font-family: 'Livvic', sans-serif;font-weight: bold;">Uniqueness | Male (30pts)</h6><p></p>
										<p style="font-family: 'Livvic', sans-serif;color:red">Note: You can only update once.</p>
										  ...
										  <text style="font-family: 'Livvic', sans-serif;">Contestant Team:</text> <input type="text" id = "team" class="re"readonly disabled/><br>
											...
											<input type="text" id="talent_uniqueness_edit" name="talent_uniqueness_edit" class="re" readonly hidden />
		...
		<script type="text/javascript">
                ...
                $('.editScore').on('click', function () {
                    ...
                    $('#team').val(data[5]);
                    $('#talent_uniqueness_edit').val(data[6]);
