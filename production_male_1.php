        ...
        <div class="container">
								<?php
										$link = mysqli_connect("localhost","root","","tabulation");
											...
											$judge = $_SESSION['login_judge'];
											$sql5 = mysqli_query($link,"SELECT  * from score_card where name_judge = '$judge' and id_contestant = 1 GROUP BY production_audience_impact_vote ORDER BY production_audience_impact_vote DESC LIMIT 1");
														...
														if($name_judgeD == $judge)
														{
															$production_audience_impact_vote = $num_rowst['production_audience_impact_vote'];
																...
																if($production_audience_impact_vote == 0)
																	...
																	{
																		echo '<li  style="display: inline;padding-right: 15px"><a class="linkage" href="production_male_2.php" style="color:black;font-family: Arial"># 2</a></li>';
										  ...
										  <img class='align-self-start mr-3' src='img/candidates/$picture' height='320px' alt='Generic placeholder image'>
											...
											<div class='media col-md-12 my-4'>
												<div class='media-body'>
													...
													$sql1 = mysqli_query($link,"SELECT *FROM score_card WHERE name_contestant = '$full_name' AND name_judge = '$judge' and id_contestant = 1");
