...
<html lang="en">
  <head>
    ...
    <title>Production Number | Mastery (30pts)</title>
      ...
      <section class="jumbotron jumbotron-fluid text-left py-4">
        <div class="container">
		      <h3 class="jumbotron-heading">Production Number (100%)</h3>
		        <p>CRITERIA:
							<ul>
								<li><a href="production_poiseBearing.php" style="color: black;" onMouseOver="this.style.color='red'" onMouseOut="this.style.color='black'">Poise and Bearing (30pts)</a></li>
								<li class="active"><a href="production_mastery.php" ><i class="fa fa-arrow-right" style="margin-left: -18px"></i> Mastery (30pts)</a></li>
